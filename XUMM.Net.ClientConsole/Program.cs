    ...
    private static async Task Main()
    {
        ...
        await ProcessTransactionAsync(client,
            JsonSerializer.Serialize(
                ...
                serializerOptions));
        await ProcessTransactionAsync(client,
            "{ \"TransactionType\": \"Payment\", \"Destination\": \"rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY\", \"DestinationTag\": 495, \"Amount\": \"1337\" }");
        await CreatePayloadAndSubscribeAsync(client, payloadConfig,
            JsonSerializer.Serialize(new XummPayloadTransaction(XummTransactionType.SignIn), serializerOptions));
